...
async function ShowData() {
  ...
  await fetch(`https://ipinfo.io/${IPAddress}?token=732c33d916ac38`)
  ...
  dataDiv.innerHTML += `
  <h3 id = 'h'>IP Address : ${IPAddress} <h3>
  ...
  .then(response => {
    ...
    dataDiv.innerHTML += `<div class="infoDiv" id="infoDiv2">
       ...
       <center> <h1> Post Offices Near You <h1></center>

        <div id="searchbarDiv">
      
        <img  id = "mg" src = "./images/search.png"/><input type="text"   placeholder="Search by Name" onkeyup="searchPostOffice()" id="searchBox"  />
        </div>
